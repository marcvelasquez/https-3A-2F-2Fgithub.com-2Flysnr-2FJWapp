    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-medical-blue-light via-background to-medical-blue-light dark:from-slate-900 dark:via-background dark:to-slate-800">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card/95 backdrop-blur-sm shadow-xl rounded-2xl p-8 border border-border/50">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-foreground text-center">Log In</h1>
            <p className="text-muted-foreground text-center mt-2">Access your JointWise account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-input border border-border rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent"
